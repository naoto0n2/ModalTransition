#
# Be sure to run `pod lib lint ModalTransition.podspec' to ensure this is a
...
Dismissing by dragging, blurring background, changing frame, customizing animation, etc. can be done easily.
  ...
  s.source_files = 'ModalTransition/Classes/**/*'
  
  # s.resource_bundles = {
  #   'ModalTransition' => ['ModalTransition/Assets/*.png']
  # }
